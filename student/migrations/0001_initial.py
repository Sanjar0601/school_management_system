    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Comer', 'Comer'), ('Waiting', 'Waiting'), ('Paid', 'Paid'), ('Unpaid', 'Unpaid'), ('First Lesson', 'First Lesson'), ('Wrong Number', 'Wrong Number'), ('Deposit', 'Deposit')], max_length=20, null=True)),
                ('source', models.CharField(blank=True, choices=[('Instagram', 'Instagram'), ('Telegram', 'Telegram'), ('Friend', 'Friend'), ('Facebook', 'Facebook')], max_length=20, null=True)),
                ...
                ('balance', models.IntegerField(blank=True, default=-599000, null=True)),
                ('comment', models.CharField(blank=True, max_length=200, null=True)),
                ('learning_duration', models.CharField(blank=True, max_length=100, null=True)),
                ('last_deduction', models.DateField(blank=True, null=True)),
                ('test', models.CharField(blank=True, max_length=100, null=True)),
                ('language', models.CharField(blank=True, choices=[('Russian', 'Russian'), ('English', 'English'), ('French', 'French')], max_length=30, null=True)),
