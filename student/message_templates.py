MESSAGE_TEMPLATES = {
    ...
    "Qarz": "Assalomu aleykum, hurmatli {name} sizni {group} kursi bo'yicha 699.000 so'm qarzdorligingiz mavjud, to'lovlarni o'z vaqtida amalga oshirishingizni so'rab qolamiz! POLYGLOT LANGUAGE SCHOOL",
